...
class MultiViewNet(nn.Module):
    ...
    def forward(self,smile,sequence,smi,seq):
        ...
        compoundFeature_onehot1 = Reduce('b c t -> b t', 'max')(compoundFeature_onehot1)
        proteinFeature_onehot1 = self.onehot_prot_net(proteinFeature_onehot)
        proteinFeature_onehot1 = Reduce('b c t -> b t', 'max')(proteinFeature_onehot1)
        #
        smiles_embedding = self.model(smi)[0]
        logits = self.SKConv1(smiles_embedding)
        logits = Reduce('b c t -> b t', 'max')(logits)
        ...
        logits1 = Reduce('b c t -> b t', 'max')(logits1)
        ...
        all_features = torch.stack([compoundFeature_onehot1,proteinFeature_onehot1,logits,logits1], dim=2)
